#!/usr/bin/env python3
"""Build true same-person before/after skin pairs from close-up portraits."""
...
# Verified face portraits (Unsplash). Mixed tones; indices 0 and 5 read Asian.
SOURCES = [
    ("https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=1400&h=1800&q=90", (0.20, 0.16, 0.80, 0.70)),
    ("https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=1400&h=1800&q=90", (0.22, 0.14, 0.78, 0.68)),
    ("https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=1400&h=1800&q=90", (0.18, 0.18, 0.82, 0.72)),
    ("https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=1400&h=1800&q=90", (0.20, 0.12, 0.80, 0.68)),
    ("https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=1400&h=1800&q=90", (0.24, 0.16, 0.76, 0.68)),
    ("https://images.unsplash.com/photo-1519699047748-de8e457a634e?auto=format&fit=crop&w=1400&h=1800&q=90", (0.22, 0.14, 0.78, 0.70)),
]
...
def main() -> None:
    ...
    for i, (url, crop) in enumerate(SOURCES, start=1):
        ...
        print("fetch", i, flush=True)
        data = fetch(url)
        raw.write_bytes(data)
        img = Image.open(io.BytesIO(data)).convert("RGB")
        # Reject non-portrait accidental downloads (very wide or tiny faces unlikely)
        if img.width < 400 or img.height < 400:
            raise SystemExit(f"source {i} too small: {img.size}")
        ...
        print("ok", i, img.size, flush=True)
